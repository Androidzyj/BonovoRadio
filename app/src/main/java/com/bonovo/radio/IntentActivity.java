...
import com.bonovo.radio.MyPreferenceFragment.CallbackSetting;
...
public class IntentActivity extends Activity implements ServiceConnection, CallbackSetting{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Intent settingIntent = new Intent("com.bonovo.RadioService");
		Intent settingIntent = new Intent(IntentActivity.this, RadioService.class);
